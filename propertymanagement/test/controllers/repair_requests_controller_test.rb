...
class RepairRequestsControllerTest < ActionController::TestCase
  ...
  test "should create repair_request" do
    assert_difference('RepairRequest.count') do
      post :create, repair_request: { close_date: @repair_request.close_date, open_date: @repair_request.open_date, request_details: @repair_request.request_details, responder_id: @repair_request.responder_id, submitter_id: @repair_request.submitter_id }
    end
  ...
  test "should update repair_request" do
    patch :update, id: @repair_request, repair_request: { close_date: @repair_request.close_date, open_date: @repair_request.open_date, request_details: @repair_request.request_details, responder_id: @repair_request.responder_id, submitter_id: @repair_request.submitter_id }
    assert_redirected_to repair_request_path(assigns(:repair_request))
  end
